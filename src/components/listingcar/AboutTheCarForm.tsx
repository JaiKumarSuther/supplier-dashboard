...
import dropdownIcon from "../../../public/images/arrow-drop-down-svgrepo-com.svg";
import ListingButtons from "../ListingButtons";

const AboutTheCarForm = () => {
  ...
  return (
    <form className="max-w-5xl w-[650px] px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="border border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center mb-6">
        ...
        <p className="text-gray-500 text-sm">you can upload upto 20jpg files</p>
        <button
          type="button"
...
export default AboutTheCarForm;
